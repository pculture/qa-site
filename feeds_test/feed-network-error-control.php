...
if ($i < 1 or $i > 3) {
	...
	<a href="http://qa.participatoryculture.org/feeds_test/feed-network-error.php">http://qa.participatoryculture.org/feeds_test/feed-network-error.php</a>
	<br />
	<BLOCKQUOTE>
	<FORM
	action="http://qa.participatoryculture.org/feeds_test/feed-network-error-control.php" method="GET">
